...
ram: $(HERMES_OBJ)
	...
	m68k-elf-size --common $(HERMES_OBJFILENAME).elf

clean:
	rm -f lib$(HERMES_OBJFILENAME).a $(HERMES_OBJFILENAME).ram  $(HERMES_OBJFILENAME).flash $(HERMES_OBJFILENAME).elf $(RTOS_ODIR)/*
